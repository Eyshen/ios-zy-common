...
@interface ZYActionSheetViewAppearanceParams : BaseZYObject
/**
 *  背景透明度 0.0f ~ 1.0f
 */
...
@implementation ZYActionSheetViewAppearanceParams
...

@interface ZYActionSheetView ()

@property(nonatomic, weak) UIView *backgroundView;

@property(nonatomic, weak) UIView<IZYActionSheetContentView> *contentView;

@property (nonatomic, assign) BOOL isHide;

@property (nonatomic, strong) ZYActionSheetViewAppearanceParams *params;
...
-(void)zy_loadSubViews {
    ...
    if (!_params) {
        self.params = [[ZYActionSheetViewAppearanceParams alloc] init];
    }
    self.isHide = YES;
    if (!_backgroundView) {
...
- (instancetype)initWithContentView:(UIView<IZYActionSheetContentView>*)contentView {
    ...
    if (self) {
        if (!contentView) {
            @throw [NSException exceptionWithName:@"ZYActionSheetViewException" reason:@"contentView not is nil" userInfo:nil];
        }
